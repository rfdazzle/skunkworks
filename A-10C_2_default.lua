...
{down = 3001, up = 3001, cockpit_device_id = 75, value_down = 1.0, name = _('HMCS Power 2-Pos ON/OFF'), category = _('HMCS Power')},
{down = 3001, up = 3001, cockpit_device_id = 75, value_down = -1.0, name = _('HMCS Power 2-Pos BAT/OFF'), category = _('HMCS Power')},

--{down = device_commands.Button_1, up = device_commands.Button_1, cockpit_device_id = devices.SCORPION_HMCS, value_down = 1.0, value_up = 0.0, name = ('HMCS Power 2-Pos ON/OFF'), category = _('HMCS Power')},
--{down = device_commands.Button_1, up = device_commands.Button_1, cockpit_device_id = devices.SCORPION_HMCS, value_down = -1.0, value_up = 0.0, name = ('HMCS Power 2-Pos BAT/OFF'), category = _('HMCS Power')},
