...
-- Custom ------------------------------------
---------------------------------------------
{	down = ufc_commands.FLIR_GAIN_Sw,		up = ufc_commands.FLIR_GAIN_Sw,		cockpit_device_id = devices.UFC,	value_down =  1.0,	value_up = 0.0,	name = _('ICP FLIR GAIN/LEVEL (special) - GAIN/LEVEL'),			category = {_('Special For Joystick'), _('Instrument Panel'), _('ICP')}},
{	down = ufc_commands.FLIR_GAIN_Sw,		up = ufc_commands.FLIR_GAIN_Sw,		cockpit_device_id = devices.UFC,	value_down =  -1.0,	value_up = 0.0,	name = _('ICP FLIR AUTO/LEVEL (special) - AUTO/LEVEL'),			category = {_('Special For Joystick'), _('Instrument Panel'), _('ICP')}},
---------------------------------------------
-- Cheat ------------------------------------
---------------------------------------------
